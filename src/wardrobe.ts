...
export const shirtMaterialQualities = ["super", "hyper", "ultra", "mega", "reroll"];
...
// rolls 7 and 9, when not identical
export const hatMetals = [
	"tungsten",
	"carbon",
	"steel",
	"aluminum",
...
// 10th hat roll, or later if metals match
export const hatBaseModifiers = [
	"super",
	"ultra",
	"mega",
	"double-",
...
// 11th hat roll, or later if metals match
export const hatBaseNames = [
	"beanie",
	"fedora",
	"trilby",
	"beret",
